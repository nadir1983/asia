...
<body>
    ...
    <h2>Soyad: <?= $product['tel'] ?></h2>

    <h2>E-Üvan: <?= $product['say'] ?></h2>

    <h2>Telefon: <?= $product['satis'] ?></h2>

    <h2>Telefon: <?= $product['materyal'] ?></h2>

     <h2>Tarix: <?= $product['iscilik'] ?></h2>
     
    <h2>Description: <?= $product['diger'] ?></h2>

    <h2>Description: <?= $product['total'] ?></h2>

    <h2>Description: <?= $product['sub'] ?></h2>
